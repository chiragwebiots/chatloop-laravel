...
<head>
    ...
    <title>@yield('title') - Chatloop</title>
    ...
    <link rel="stylesheet" href="{{ asset('install/css/install.css') }}">
...
<body>
                        ...
                        <div class="col-sm-12">
                            <div class="wizard-step-container">
                                ...
                                <div class="wizard-form-details">
                                    @include('install.partials.session')
                                    @yield('content')
                                </div>
                            </div>
                        </div>
    ...
    {{-- <script src="{{ asset('install/js/feather-icon/feather-icon.js') }}"></script> --}}
    @yield('scripts')
</body>
