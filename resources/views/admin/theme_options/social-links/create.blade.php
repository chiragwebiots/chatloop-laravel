...
@section('title', __('static.social_links.create'))
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5>{{ __('static.social_links.create') }}</h5>
        </div>
        {!! Form::open(['route' => 'admin.social-links.store', 'method' => 'POST', 'class' => 'needs-validation']) !!}
        <div class="card-body">
