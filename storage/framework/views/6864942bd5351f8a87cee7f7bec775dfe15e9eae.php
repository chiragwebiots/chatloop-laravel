                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active select_image" data-bs-toggle="tab"
                            data-bs-target="#select"><?php echo e(__('static.media.select_file')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link upload-image" data-bs-toggle="tab"
                            data-bs-target="#upload"><?php echo e(__('static.media.upload_new')); ?></a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="upload">
                        ...
                        <div class="dz-message needsclick">
                            ...
                            <h4 class="mb-0 f-w-600"><?php echo e(__('static.media.drop_message')); ?></h4>
                        </div>
                        <?php echo Form::close(); ?>
            ...
            <div class="modal-footer">
                <div class="left-part">
                    <div class="file-detail">
                        <h6 class="selected-count"><?php echo e(__('static.media.0_file_selected')); ?></h6>
                        <button class="btn btn-sm btn-primary font-red clear">Clear</button>
                    </div>
                </div>
                <div class="right-part">
                    <a href="#" class="btn btn-solid select-media btn-add"
                        data-bs-dismiss="modal"><?php echo e(__('static.media.add')); ?></a>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/webiots/Desktop/Git_hub/chat_loop_OPTIMIZE_CODE/chat_loop/resources/views/admin/inc/files.blade.php ENDPATH**/ ?>