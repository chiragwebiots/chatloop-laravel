    ...
    (function($) {
        ...
        function selectedMedia() {
            ...
            Media.selectedFiles.forEach((data) => {
                ...
                html += '<div class="img-part b_size_content"><img src="<?php echo e(url('/')); ?>/' + data.url +
                ...
                success: function(res) {
                    ...
                    if (Media.data.length) {
                        Media.data.forEach((data) => {
                            ...
                            html +=
                                '<div class="img-part bg-size-contain"><img src="<?php echo e(url('/')); ?>/' +
                                data.url +
        ...
        $(document).on('click', '.btnDelete', function(e) {
            ...
            let url = "<?php echo e(route('admin.media.destroy', '')); ?>" + "/" + id;
            $.ajax({
                type: 'POST',
                url: url,
                data: {
        ...
        $('.toggle-class').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('admin.theme.update')); ?>',
                data: {
                    _method: 'PUT',
                    [switch_name]: status,
                },
...
<?php /**PATH /home/webiots/Desktop/Git_hub/chat_loop_OPTIMIZE_CODE/chat_loop/resources/views/admin/layouts/partials/script.blade.php ENDPATH**/ ?>